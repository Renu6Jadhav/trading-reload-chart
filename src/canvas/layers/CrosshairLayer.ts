...
export class CrosshairLayer {
	...
	constructor(options: CrosshairLayerOptions) {
		...
		this.crosshairColor =
			options.crosshairColor ?? CHART_CONFIG.crosshair.color;

		this.crosshairThickness =
			options.crosshairThickness ?? CHART_CONFIG.crosshair.thickness;

		this.crosshairStyle =
			options.crosshairStyle ?? CHART_CONFIG.crosshair.style;
	}
